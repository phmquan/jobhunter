...
import vn.uit.jobhunter.domain.request.ReqLoginDTO;
...
public class AuthController {
    ...
    public ResponseEntity<ResLoginDTO> login(@Valid @RequestBody ReqLoginDTO loginDto) {
        ...
        // update user
        this.tokenService.updateUserToken(refresh_token, loginDto.getUsername());
    ...
    public ResponseEntity<ResLoginDTO> getRefreshToken(
        ...
        // update user
        this.tokenService.updateUserToken(new_refresh_token, email);
    ...
    public ResponseEntity<Void> logout() throws IdInvalidException {
        ...
        this.tokenService.updateUserToken(null, email);
...
//        postmanUser.setRole(this.userService.getRoleByName("USER"));
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(this.userMapperDTO.convertToResCreateUserDTO(currentUser));
    }
}
