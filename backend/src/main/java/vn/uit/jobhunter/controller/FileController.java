...
import vn.uit.jobhunter.domain.response.file.ResUploadFileDTO;
import vn.uit.jobhunter.service.FileService;
import vn.uit.jobhunter.util.annotation.ApiMessage;
import vn.uit.jobhunter.util.error.StorageException;
...
public class FileController {
    ...
    public ResponseEntity<Resource> getFile(@PathVariable("filename") String filename) {
        try {
            // Remove the "file://" prefix and get the actual path
            String basePath = baseURI.replace("file:///", "");
            Path file = Paths.get(basePath).resolve("resume/"+filename);
            ...
            System.out.println("Looking for file: " + file.toAbsolutePath());
